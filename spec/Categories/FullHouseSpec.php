...
class FullHouseSpec extends ObjectBehavior
{
    ...
    function it_should_score_25_points(DiceThrow $diceThrow)
    {
        $this->score($diceThrow)->shouldEqual(25);
    }

    function it_should_evaluate_true_if_there_are_three_of_a_kind_and_two_of_a_kind(DiceThrow $diceThrow)
    {
        $diceThrow->values()->willReturn([3, 3, 4, 4, 4]);
        $this->evaluate($diceThrow)->shouldBe(true);
    }

    function it_should_return_false_otherwise(DiceThrow $diceThrow)
    {
