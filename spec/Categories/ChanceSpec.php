...
{
    function it_should_always_be_able_to_evaluate(DiceThrow $diceThrow)
    {
        $this->evaluate($diceThrow)->shouldBe(true);
    }

    function it_should_have_a_total_score_which_is_the_sum_of_its_values(DiceThrow $diceThrow)
    {
